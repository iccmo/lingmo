...
export function SceneEditor({ chapterContent, onSave, saving }: Props) {
 ...
 title="编辑场景"
 >
 <PenLine size={12} className="inline" />
 </button>
 ...
 className="text-[10px] text-ink-muted hover:text-destructive disabled:opacity-30 px-1"
 title="删除场景"
 >
 ...
 {scene.content || <span className="text-ink-subtle italic">(空场景 - 点击 <PenLine size={12} className="inline" /> 编辑)</span>}
 </pre>
 )}
 </div>
 )}
