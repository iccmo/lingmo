  ...
  return (
    <div className="fixed bottom-20 right-8 z-40 bg-card border border-border rounded-xl shadow-xl p-4 w-[260px] animate-[fadeSlideIn_0.2s_ease-out]">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-heading text-sm font-semibold text-ink">⏱️ 专注冲刺</h3>
      ...
      <div className="flex gap-2">
        {!running ? (
          ...
          <button onClick={stop}
            className="flex-1 text-xs py-1.5 rounded-md bg-amber-500 text-white hover:bg-amber-600 transition-colors">
            ⏸ 暂停
          </button>
        )}
      ...
      {!running && seconds === 0 && wordsWritten > 0 && (
        <p className="text-[10px] text-emerald-500 text-center mt-2 animate-[fadeSlideIn_0.3s_ease-out]">
