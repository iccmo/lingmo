...
const EVENT_TYPE_COLORS: Record<string, { bg: string; dot: string; label: string }> = {
 plot: {
 bg: 'bg-info-soft border-info/20 dark:bg-blue-950/30 dark:border-blue-800',
 dot: 'bg-info-soft0',
 label: '情节',
 },
 revelation: {
 bg: 'bg-warn-soft border-warn/20 dark:bg-amber-950/30 ',
 dot: 'bg-warn-soft0',
 label: '揭示',
 },
 cliffhanger: {
 bg: 'bg-destructive-soft border-destructive/20 dark:bg-red-950/30 ',
 dot: 'bg-destructive-soft0',
 label: '悬念',
 },
 other: {
