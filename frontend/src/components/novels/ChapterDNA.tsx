...
export function ChapterDNA({ chapters, novelId }: { chapters?: ChapterMeta[]; novelId: string }) {
 ...
 <h3 className="font-heading text-base font-semibold text-ink mb-3"><Dna size={12} className="inline" /> 章节 DNA 对比</h3>
 ...
 <span className={diff > 10 ? 'text-success' : diff < -10 ? 'text-warn' : 'text-ink-subtle'}>
