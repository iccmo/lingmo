...
const SHOT_TYPE_COLORS: Record<string, string> = {
  ...
  'wide': 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20',
        ...
        <>
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            {storyboard.overall_mood && (
              <span className="px-2 py-1 bg-amber-500/10 border border-amber-500/20 rounded text-amber-700">
                {storyboard.overall_mood}
              </span>
            )}
            {storyboard.pacing && (
              <span className="px-2 py-1 bg-sky-500/10 border border-sky-500/20 rounded text-sky-700">
                {storyboard.pacing}
              </span>
            )}
