  ...
  return (
    <div className="page-enter">
      ...
      {(errorSummary.critical > 0 || errorSummary.errors > 0) && (
        <div className="mb-4 p-4 rounded-xl bg-red-50/50 dark:bg-red-950/20 border border-red-200 dark:border-red-800">
          <h3 className="text-xs font-semibold text-red-600 dark:text-red-400 mb-2">📊 错误摘要（最近50条）</h3>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px] mb-2">
            {errorSummary.critical > 0 && <div className="p-2 rounded-lg bg-red-100/50 dark:bg-red-900/20 text-center"><div className="font-bold text-red-600">🔴 {errorSummary.critical}</div><div className="text-red-500">严重</div></div>}
            ...
            {errorSummary.warnings > 0 && <div className="p-2 rounded-lg bg-amber-100/50 dark:bg-amber-900/20 text-center"><div className="font-bold text-amber-600">🟡 {errorSummary.warnings}</div><div className="text-amber-500">警告</div></div>}
            ...
            return (
              <div key={log.id}
                className={`rounded-lg border transition-all ${
                  ...
                  cls.severity === 'critical' ? 'border-red-100 dark:border-red-900/30 bg-red-50/20 dark:bg-red-950/5' :
