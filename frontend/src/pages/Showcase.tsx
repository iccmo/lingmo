...
import { BookOpen, Bot, Brain, Calendar, ClipboardCheck, Dna, Download, Eye, FileSearch, Flame, Keyboard, Lightbulb, Lock, Mic, Moon, Music, Network, Palette, PenLine, Pin, ScanSearch, Search, Smartphone, Sparkles, Telescope, TestTubes, Timer, TrendingUp, Type, Users, Wand2 } from 'lucide-react';

const FEATURES = [
 { icon: 'Brain', title: '5-Gate 质量管线', desc: '构思→草拟→评审→润色→质检，每章经五道关卡淘汰，不达标自动重写', tag: '核心' },
 { icon: 'Search', title: 'LLM 质量评审', desc: '6维度+题材特化：钩子强度·节奏感·对话自然度·可读性·反派压迫感·追读意愿，0-1精确到百分位', tag: '核心' },
 { icon: 'Users', title: 'AI 读者角色扮演', desc: '4种读者人格（老书虫/追更狂魔/女频编辑/硬核设定控）用自然语言给你的章节写读后感', tag: '核心' },
 { icon: 'Flame', title: '段落级读者热力图', desc: '逐段预测读者反应：兴奋·好奇·爆笑·感动·舒适·紧张，彩色标注', tag: '核心' },
 { icon: 'Telescope', title: '伏笔追踪系统', desc: '自动检测已埋/已回收伏笔，超过10章未回收触发警告，确保长篇自洽', tag: '核心' },
 { icon: 'ClipboardCheck', title: '番茄算法检查', desc: '发布前六项检查：钩子·标题·长度·质量·对话·题材，一键评估发布就绪度', tag: '核心' },
 { icon: 'Smartphone', title: '手机阅读模拟', desc: '5种真机尺寸（iPhone SE→Pro Max→Pixel 7→iPad Mini），字体调节·暗色模式·滑动翻页', tag: '核心' },
 { icon: 'Calendar', title: '智能发布策略', desc: '自动识别最强章，推荐最佳发布时间和节奏，适配番茄/起点/纵横三大平台', tag: '核心' },
 { icon: 'TestTubes', title: '开局 A/B 测试', desc: '金庸/余华/爆款网文三种声音生成不同开头，并排对比质量分+钩子+预览', tag: '核心' },
 { icon: 'TrendingUp', title: '情感弧线可视化', desc: 'SVG双线图：张力曲线+钩子曲线，自动标注高潮点和过渡点，定位读者流失风险', tag: '' },
 { icon: 'Eye', title: '读者留存模拟', desc: '逐章计算流失概率（质量低-40%·钩子弱-15%·字数少-20%），预测最终留存率', tag: '' },
 { icon: 'Dna', title: '章节DNA对比', desc: '六维雷达图：节奏/对话/描写/动作/情感/钩子，任意两章并排对比差异百分比', tag: '' },
 { icon: 'Palette', title: '情绪配方分析', desc: '每章拆解六种情绪占比（紧张·好奇·爽感·感动·幽默·恐惧），检测情绪单一风险', tag: '' },
 { icon: 'Network', title: '情节网络图', desc: '力导向角色关系图谱，点击角色显示所有关系+关联伏笔，100章长篇的叙事地图', tag: '' },
 { icon: 'ScanSearch', title: '反套路检测器', desc: '8种网文套路自动检测，每项给出反套路建议。含作者DNA报告（强项/弱项/适合题材）', tag: '' },
 { icon: 'PenLine', title: '章节内联编辑', desc: '阅读→编辑无缝切换，展开章节直接修改正文并保存，无需跳转到独立编辑器', tag: '' },
 ...
 { icon: 'Type', title: '智能标题优化', desc: '章节标题评分+质量趋势+字数走向。低分标题hover显示AI建议的替代标题', tag: '' },
 { icon: 'Pin', title: '章节分组管理', desc: '自动识别「第X卷/部/篇」标记，卷间可折叠。章节审批流转（已审/待改/草稿）+置顶', tag: '' },
 { icon: 'Wand2', title: '一键智能续写', desc: '自动读取上章结尾钩子注入上下文，也支持手动输入8种快捷方向（打斗/感情/反转...）', tag: '' },
 { icon: 'Lightbulb', title: '写困救援', desc: '卡文时一键获取3条具体剧情方向建议（基于你的角色和伏笔，非泛泛建议）', tag: '' },
 { icon: 'FileSearch', title: '全文搜索', desc: 'Ctrl+Shift+F 跨所有章节正文搜索，结果按章节分组+匹配片段预览+点击直达', tag: '' },
 { icon: 'Bot', title: '全自动日更', desc: '一键启动自动模式，后台持续生成章节。配合发布流程，真正做到无人值守日更', tag: '' },
 { icon: 'Timer', title: '专注冲刺计时器', desc: 'Pomodoro风格写作计时器，15/25/45/60分钟可选，实时速率追踪，完成提醒', tag: '' },
 { icon: 'Keyboard', title: '极速操作', desc: 'Ctrl+K 命令面板·Ctrl+G 生成·J/K 浏览章节·Ctrl+Shift+F 全文搜索·? 快捷键速查', tag: '' },
 { icon: 'Moon', title: '深色模式', desc: '跟随系统自动切换明暗主题，全局0.3s平滑过渡动画，自定义滚动条。首次访问无需手动设置', tag: '' },
 { icon: 'Download', title: 'EPUB 导出', desc: '一键导出完整小说为 EPUB 电子书，带封面+目录+样式，可直接上传 Kindle 或阅读平台', tag: '' },
 { icon: 'Lock', title: '密码保护', desc: '浏览器本地密码登录，关闭标签页自动退出。无需服务器，你的创作只有你能访问', tag: '' },
];
...
export function Showcase({ onEnter }: { onEnter?: () => void }) {
 ...
 <Sparkles size={18} className="text-accent" /> <span className="text-accent">灵墨</span>
 </span>
 ...
 {[
 { step: '01', icon: 'Settings', title: '配置 API Key', desc: '在设置页填入 DeepSeek API Key，新用户免费500万tokens。也支持OpenAI、通义千问等', color: 'from-violet-500/10 to-violet-500/5' },
 { step: '02', icon: 'PenLine', title: '创建小说', desc: '输入书名、题材、一句话简介。AI自动构建世界观、角色体系、势力格局和章节大纲', color: 'from-accent/10 to-accent/5' },
 { step: '03', icon: 'Zap', title: '生成 & 发布', desc: '一键生成章节，5道质量关卡自动打磨。满意后发布到番茄小说平台，开始赚取收益', color: 'from-emerald-500/10 to-emerald-500/5' },
 ].map((s, i) => (
 <div key={i}
 ...
 {[
 { icon: 'Lightbulb', name: '构思', desc: '分析前文剧情\n构思章节走向' },
 { icon: 'PenLine', name: '草拟', desc: '生成正文初稿\n多版本候选对比' },
 { icon: 'TestTubes', name: '评审', desc: '6维LLM评分\n低于0.5分重写' },
 { icon: 'Sparkles', name: '润色', desc: '去AI味处理\n提升文学质感' },
 { icon: 'ShieldCheck', name: '质检', desc: '事实核查纠错\n终审放行发布' },
 ].map((g, i) => (
 ...
 i === 1 ? 'bg-info-soft dark:bg-sky-900/30' :
 i === 2 ? 'bg-warn-soft dark:bg-amber-900/30' :
 i === 3 ? 'bg-success-soft dark:bg-emerald-900/30' :
 ...
 <span className="text-2xl shrink-0 text-accent">{(() => { const icons: Record<string, React.ElementType> = { Brain, Search, Users, Flame, Telescope, ClipboardCheck, Smartphone, Calendar, TestTubes, TrendingUp, Eye, Dna, Palette, Network, ScanSearch, PenLine, Mic, BookOpen, Type, Pin, Wand2, Lightbulb, FileSearch, Bot, Timer, Keyboard, Moon, Download, Lock, Music }; const I = icons[f.icon]; return I ? <I size={24} /> : null; })()}</span>
 ...
 {loginError && (
 <p className="text-xs text-destructive mt-2 text-center">{loginError}</p>
 )}
 ...
 <span className="font-heading text-base font-semibold text-ink flex items-center gap-1"><Sparkles size={14} className="text-accent" /> 灵墨</span>
