...
export function Outline() {
 ...
 generated
 ? 'bg-success-soft0 border-emerald-500'
 ...
 {generated && <Badge className="text-[9px] bg-success-soft dark:bg-emerald-950/30 text-success border-success/20 ">已生成</Badge>}
 ...
 <button className="text-xs h-7 px-2 text-destructive hover:text-destructive dark:hover:text-destructive transition-colors"
